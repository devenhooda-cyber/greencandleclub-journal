...
export default function Home() {
  ...
  if (loading && !authTimedOut) {
    return (
      <div style={{ height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#061C16", color: "#1FA971", fontFamily: "sans-serif" }}>
        Loading Green Candle Club...
      </div>
    );
  }
  ...
  if (!user) {
    return (
      <div style={{
        ...
        background: "linear-gradient(135deg, #061C16 0%, #14181D 100%)",
        color: "white",
        ...
        <div style={{
          ...
          <div style={{ marginBottom: "24px", display: "flex", justifyContent: "center" }}>
            <svg width="70" height="70" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 2V6M12 18V22M7 6H17V18H7V6Z" stroke="#1FA971" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
              <rect x="7" y="6" width="10" height="12" fill="rgba(31, 169, 113, 0.15)" stroke="#1FA971" strokeWidth="2"/>
            </svg>
          </div>
          
          {/* Brand Name */}
          <h1 style={{ fontSize: "28px", margin: "0 0 8px 0", fontWeight: "800", letterSpacing: "1.5px", color: "#ffffff" }}>
            GREEN CANDLE CLUB
          </h1>
          <p style={{ color: "#9FB4C7", fontSize: "15px", marginBottom: "35px", lineHeight: "1.5" }}>
            Advanced Trading Journal &<br/>Market Regime Scorecard
          </p>

          {authError && (
            <div style={{ background: "rgba(142, 30, 34, 0.15)", borderLeft: "4px solid #8E1E22", color: "#F2CFCF", padding: "12px", marginBottom: "25px", fontSize: "14px", textAlign: "left", borderRadius: "4px" }}>
              {authError}
            </div>
          )}
  ...
  return (
    <div>
      <div style={{ background: "#14181D", color: "white", padding: "12px 24px", display: "flex", justifyContent: "flex-end", gap: "20px", alignItems: "center", fontFamily: "system-ui, sans-serif", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginRight: "auto" }}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2V6M12 18V22M7 6H17V18H7V6Z" stroke="#1FA971" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span style={{ fontSize: "14px", fontWeight: "700", letterSpacing: "1px" }}>GREEN CANDLE CLUB</span>
        </div>
        
        <span style={{ fontSize: "14px", color: "#9FB4C7" }}>{user.displayName}</span>
        <button 
          onClick={() => signOut(auth)} 
          style={{ padding: "6px 14px", cursor: "pointer", background: "transparent", color: "#1FA971", border: "1px solid #1FA971", borderRadius: "6px", fontSize: "13px", fontWeight: "600", transition: "all 0.2s ease" }}
          onMouseOver={(e) => { e.currentTarget.style.background = "#1FA971"; e.currentTarget.style.color = "#fff"; }}
          onMouseOut={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "#1FA971"; }}
        >
          Logout
        </button>
      </div>
      
      {/* नीचे दिया गया आपका ओरिजिनल ऐप यहाँ बिना किसी बदलाव के रेंडर होगा */}
      <RegimeDeskApp />
    </div>
  );
}
...
// ============================================================
// अपना पुराना REGIME DESK का कोड (REGIMES, SEED_LIBRARY, RegimeDeskApp आदि) यहाँ नीचे बिल्कुल वैसे ही रहने दें
// ============================================================
