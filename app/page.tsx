  ...
  if (!user) {
    return (
      <div style={{ padding: "100px 20px", textAlign: "center", fontFamily: "sans-serif" }}>
        <h1>Regime Desk</h1>
        <p>Market regime scorecard + trade edge analyser</p>
        {authError && <p role="alert" style={{ color: "#8E1E22" }}>{authError}</p>}
        <button 
          onClick={() => {
            setAuthError("");
          ...
          style={{ padding: "12px 24px", fontSize: "16px", cursor: "pointer", background: "#14181D", color: "white", border: "none" }}
        >
          Login with Google
        </button>
      </div>
